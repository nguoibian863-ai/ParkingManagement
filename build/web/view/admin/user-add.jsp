...
<%
    ...
    String nextId = new UserDao().nextUserId();
...
<body class="pm-dashboard-layout">
    ...
    <div class="pm-dash-body">
        ...
        <main class="pm-dash-main">
            <h2 class="pm-dash-content-title">Th&#234;m t&#224;i kho&#7843;n m&#7899;i</h2>
            <% if (error != null) { %><p class="pm-error" style="max-width:400px;"><%= error %></p><% } %>
            <div class="pm-dash-table-wrap" style="max-width:480px;">
                <form action="<%= ctx %>/admin/user?action=add" method="post" class="pm-form" style="padding:24px;">
                    <div class="pm-form-group">
                        <label>User ID</label>
                        <input type="text" name="userId" value="<%= nextId %>" required readonly style="background:#f1f5f9;">
                    </div>
                    <div class="pm-form-group">

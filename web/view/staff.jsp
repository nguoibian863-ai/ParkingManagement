...
<%
    ...
    model.ParkingLot currentLot = (model.ParkingLot) request.getAttribute("currentLot");
...
<head>
    ...
    <title>Staff - Car Parking Management System</title>
...
<body class="pm-dashboard-layout">
    ...
    <div class="pm-dash-body">
        ...
        <main class="pm-dash-main">
            ...
            <h2 class="pm-dash-content-title">B&#7843;n &#273;&#7891; v&#7883; tr&#237; &#273;&#7895; xe<% if (currentLot != null) { %> — <%= currentLot.getLotName() %><% } else { %> <span class="pm-dash-lot-all">(T&#7845;t c&#7843; b&#227;i)</span><% } %></h2>
            <div class="pm-slot-map-wrap">
                <div class="pm-slot-map">
                    ...
                    <% } %>
                    <% if (slotList.isEmpty()) { %>
                    <p class="pm-slot-map-empty">Ch&#432;a c&#243; v&#7883; tr&#237; &#273;&#7895; xe n&#224;o.</p>
                    <% } %>
                </div>
            </div>
        </main>
